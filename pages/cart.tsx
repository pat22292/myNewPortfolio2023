...
const Cart = (props) => {
    ...
    const calcDistance = async (origin) => {
        ...
        // formData.append('origin', 'St. Agatha Square, Guiguinto, Bulacan');
        // formData.append('destination', 'Bagumbayan, Pangulang Street, Bulakan, Bulacan');
        try {
