    ...
    return (
        ...
        <div>
            <Head>
                ...
                <meta property="og:image" content={`https://laravel-api-template-2022.fly.dev/api/text-image/${router.query.id}`} key="ogimage" />
                ...
                <meta name="twitter:image" content={`https://laravel-api-template-2022.fly.dev/api/text-image/${router.query.id}`} />
            </Head>
